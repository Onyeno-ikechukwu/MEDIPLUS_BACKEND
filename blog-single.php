						...
						<div class="main-menu">
							<nav class="navigation">
								<ul class="nav menu">
									...
									<li class="active"><a href="#">Blogs <i class="icofont-rounded-down"></i></a>
										<ul class="dropdown">
						...
						<div class="row">
							...
							<div class="col-12">
								<div class="blog-comments">
									<h2>All Comments</h2>
									<?php require_once "core/view/viewcomments.php"; ?>
								</div>
							</div>
							<div class="col-12">
								<div class="comments-form">
									<h2>Leave Comments</h2>
									<?php require_once "core/view/comments.php"; ?>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-12">
					<div class="single-footer">
						...
						<form method="get" target="_blank" class="newsletter-inner" method="post" action="core/control/newsletterBlog.php">
