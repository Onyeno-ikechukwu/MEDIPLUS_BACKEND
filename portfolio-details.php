								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu">
											...
											<li class="active"><a href="#">Portfolio <i class="icofont-rounded-down"></i></a>
												<ul class="dropdown">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-12">
					<div class="single-footer">
						...
						<form method="get" target="_blank" class="newsletter-inner" method="post" action="core/control/newsletterPortfolio.php">
