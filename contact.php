					...
					<div class="col-lg-7 col-md-9 col-12">
						<div class="main-menu">
							<nav class="navigation">
								<ul class="nav menu">
									<li ><a href="home">Home <i class="icofont-rounded-down"></i></a>
										<ul class="dropdown">
					...
					<div class="row"> 
						...
						<div class="col-lg-6">
							<div class="contact-us-form">
								...
								<form class="form" method="post" action="core/control/contact.php">
									<div class="row">
										<div class="col-lg-6">
					...
					<div class="row">
						<div class="col-lg-4 col-12 ">
							<div class="single-info">
								...
								<div class="content">
									<h3>+234 8100 655 045</h3>
									<p>Onyenoikechukwu081006@gmail.com</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-12 ">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-12">
					<div class="single-footer">
						...
						<form method="get" target="_blank" class="newsletter-inner" method="post" action="core/control/newsletterContact.php">
